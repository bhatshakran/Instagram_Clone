  ...
  return (
    <div className="min-h-screen pt-6 mt-8 border-t md:border-t-0 md:w-2/3 md:mx-auto">
      ...
      <div className="w-3/4 ">
        ...
        {/* website */}
        <div className="grid grid-cols-1 mx-4 mt-8 name_edit md:grid-cols-6">
          <label htmlFor="webiste" className="font-medium text-md md:col-start-1 md:col-end-2">
            Website
          </label>
          <input type="text" name="website" id="" className="py-1 border md:col-start-2 md:col-end-7" />
        </div>
        {/* Bio */}
        <div className="grid grid-cols-1 mx-4 mt-8 name_edit md:grid-cols-6">
